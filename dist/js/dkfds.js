  ...
  if (trueTooltip) {
    ...
    tooltipTarget.addEventListener('mouseleave', function (e) {
      ...
      if (wrapper.classList.contains('place-above')) {
        onTooltip = tooltipTarget.getBoundingClientRect().left <= e.clientX && e.clientX <= tooltipTarget.getBoundingClientRect().right && tooltipTarget.getBoundingClientRect().top >= e.clientY;
      } else if (wrapper.classList.contains('place-below')) {
        onTooltip = tooltipTarget.getBoundingClientRect().left <= e.clientX && e.clientX <= tooltipTarget.getBoundingClientRect().right && tooltipTarget.getBoundingClientRect().bottom <= e.clientY;
      }
    ...
    tooltipEl.addEventListener('mouseleave', function (e) {
      ...
      let onTarget = false;
      if (wrapper.classList.contains('place-above')) {
        onTarget = tooltipEl.getBoundingClientRect().left <= e.clientX && e.clientX <= tooltipEl.getBoundingClientRect().right && tooltipEl.getBoundingClientRect().bottom <= e.clientY;
      } else if (wrapper.classList.contains('place-below')) {
        onTarget = tooltipEl.getBoundingClientRect().left <= e.clientX && e.clientX <= tooltipEl.getBoundingClientRect().right && tooltipEl.getBoundingClientRect().top >= e.clientY;
      }
...
function setLeft(tooltipTarget, tooltipEl) {
  ...
  /* If the tooltip exceeds the right side of the screen, adjust it */else if (tooltipEl.getBoundingClientRect().right > document.body.clientWidth - PAGE_MARGIN) {
