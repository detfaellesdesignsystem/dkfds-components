...
function updateCheckboxList(e) {
  ...
  if (checkbox.checked) {
    ...
    for (var _c = 0; _c < checkboxList.length; _c++) {
      ...
      checkboxList[_c].parentNode.parentNode.parentNode.classList.remove('table-row-selected');
    }
  }
